...
//------------------
var secretKey = "6EiDFnj7v4wDmHgasOYyEn34cVNnC4eVdsUAAABl";
...
describe('BSS Sanity Suite', () => {
    it('USER/Login API', async function () {
        ...
        try {
            ...
            updatedRequestBody.credentialsExtAuth.deviceInfo.deviceId='38596700130210077';
            updatedRequestBody.credentialsExtAuth.deviceInfo.deviceIdType='DEVICEID';
            updatedRequestBody.credentialsExtAuth.deviceInfo.deviceType="ANDROID_TV_STB";
            updatedRequestBody.credentialsExtAuth.credentials.secret = secretKey;
            updatedRequestBody.credentialsExtAuth.credentials.client_id='opus';
            updatedRequestBody.credentialsExtAuth.credentials.state='fb1b6c54-1933-4ed5-995d-935e18518f73';
            updatedRequestBody.credentialsExtAuth.credentials.redirect_uri='http://localhost';
